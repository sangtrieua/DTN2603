...
//        creatDepartment(listDeparmet,department);
//        System.out.println(department.toString());
////        Question 7:
////        Nhập số chẵn từ console
//        int soChan;
//        while(true){
//            System.out.println("nhap 1 so chan: ");
//            if (!scanner.hasNextInt()){
//                System.out.println("Ban vua nhap khong phai la so nguyen : ");
//                continue;
//            }
//            soChan = scanner.nextInt();
//            scanner.nextLine();
//            if(soChan%2==1){
//                System.out.println("ban vua nhap so le hay nhap laio:");
//                continue;
//            }
//            break;
//        }
...
//        return po;
//    }
//    public static Department findDepartmentByName(Department[] departments, String name) {
//        Department dep = null;
//        for (Department department : departments) {
//            if (department.departmentName.equals(name)) {dep=department; break;}
//        }
//        return dep;
//    }
//    public static void creatDepartment(Department[] departments, Department department) {
//        Scanner sc = new Scanner(System.in);
//        String name;
//
//        while (true){
...
//            name=sc.nextLine();
//            Department dep = findDepartmentByName(departments, name);
//            if(dep!=null){
//                System.out.println("ten da ton tai hay nhapj lai");
//                continue;
//            }
//            department.departmentId = departments.length+1;
